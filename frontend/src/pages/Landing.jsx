...
export default function Landing() {
  ...
  return (
    <div className="min-h-dvh bg-slate-900 text-white">
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-900/90 backdrop-blur-xl border-b border-slate-800 safe-top">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-hk-500 rounded-lg flex items-center justify-center">
              <Camera size={16} className="text-white" />
            </div>
            <span className="font-bold text-base tracking-tight">HK Camera</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Link to="/login" className="btn-ghost text-sm px-3">Log in</Link>
            <button onClick={() => navigate('/register')} className="btn-primary text-sm px-4">Get Started</button>
          </div>
        </div>
      </header>
      ...
      <section className="pt-36 pb-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
            <button onClick={() => navigate('/register')} className="btn-primary text-lg px-8 py-3.5 shadow-lg shadow-hk-500/25 hover:shadow-hk-500/40">
      ...
      <section id="products" className="py-24 px-4 sm:px-6 bg-slate-800/30 border-y border-slate-700/20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={title} className="card p-6 sm:p-8 hover:scale-[1.01] transition-transform">
      ...
      <section id="how-it-works" className="py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">Get started in under a minute. No installation, no hardware, no credit card.</p>
          </div>
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-12">
            {[
              ...
              <div key={step} className="text-center">
                <div className="w-14 h-14 bg-hk-500/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Icon size={26} className="text-hk-400" />
                </div>
                <div className="text-hk-500 font-bold text-xs mb-2 tracking-widest">STEP {step}</div>
      ...
      <section className="py-24 px-4 sm:px-6 bg-slate-800/30 border-y border-slate-700/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
              Enterprise-grade <span className="text-hk-400">security</span>
            </h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">Your video feeds and data are protected with modern encryption and security practices.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={title} className="card p-6">
                <div className="w-10 h-10 bg-hk-500/20 rounded-xl flex items-center justify-center mb-3">
                  <Icon size={18} className="text-hk-400" />
                </div>
                <h3 className="text-base font-semibold mb-2">{title}</h3>
                <p className="text-slate-400 text-sm leading-relaxed">{desc}</p>
              </div>
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">Ready to secure your space?</h2>
          <p className="text-slate-400 text-lg mb-8">Set up your first camera in under a minute. No credit card required.</p>
          <button onClick={() => navigate('/register')} className="btn-primary text-lg px-8 py-3.5 shadow-lg shadow-hk-500/25 hover:shadow-hk-500/40">
