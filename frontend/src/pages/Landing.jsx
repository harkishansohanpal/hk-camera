...
export default function Landing() {
  ...
  return (
    <div className="min-h-dvh bg-white text-gray-900">
      {/* ── Nav ────────────────────────────────────────────── */}
      <header className="nav-bar fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-b border-ap-separator">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-ap-blue rounded-xl flex items-center justify-center shadow-sm">
              <Camera size={16} className="text-white" />
            </div>
            <span className="font-bold text-base tracking-tight text-gray-900">HK Camera</span>
          </div>
          <div className="hidden sm:flex items-center gap-6">
            <button onClick={() => document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' })}
              className="text-sm font-medium text-ap-gray hover:text-gray-900 transition-colors">Products</button>
            <button onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })}
              className="text-sm font-medium text-ap-gray hover:text-gray-900 transition-colors">How it Works</button>
            <button onClick={() => navigate('/pricing')}
              className="text-sm font-medium text-ap-gray hover:text-gray-900 transition-colors">Pricing</button>
          </div>
          <div className="flex items-center gap-2">
            <Link to="/login" className="btn-ghost text-sm px-4 text-ap-gray hover:text-gray-900">Log in</Link>
      ...
      <section className="pt-36 pb-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl sm:text-7xl font-bold tracking-tight max-w-4xl mx-auto leading-[1.05] text-gray-900">
            Turn any device into a{' '}
            <span className="text-ap-blue">smart security camera</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-ap-gray max-w-2xl mx-auto leading-relaxed">
      ...
      {/* ── Products ──────────────────────────────────────── */}
      <section id="products" className="py-24 px-4 sm:px-6 bg-ap-gray6 border-y border-ap-separator">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-ap-gray max-w-2xl mx-auto text-lg">Check in all around home with easy-to-set-up security cameras — no hardware required.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={title} className="card-highlighted p-6 sm:p-8 transition-all duration-200">
                ...
                <p className="text-ap-gray text-sm leading-relaxed">{desc}</p>
              </div>
            ))}
          </div>
      ...
      <section id="how-it-works" className="py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-ap-gray text-lg max-w-2xl mx-auto">Get started in under a minute. No installation, no hardware, no credit card.</p>
          </div>
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-12">
            {[
              ...
              <div key={step} className="text-center">
                ...
                <p className="text-ap-gray text-sm leading-relaxed max-w-xs mx-auto">{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── Security ──────────────────────────────────────── */}
      <section className="py-24 px-4 sm:px-6 bg-ap-gray6 border-y border-ap-separator">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 text-gray-900">
              Enterprise-grade <span className="text-ap-blue">security</span>
            </h2>
            <p className="text-ap-gray text-lg max-w-2xl mx-auto">Your video feeds and data are protected with modern encryption and security practices.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 text-gray-900">Ready to secure your space?</h2>
          <p className="text-ap-gray text-lg mb-8">Set up your first camera in under a minute. No credit card required.</p>
          <button onClick={() => navigate('/register')} className="btn-primary text-lg px-8 py-3.5 shadow-apple-lg">
      ...
      {/* ── Footer ────────────────────────────────────────── */}
      <footer className="border-t border-ap-separator py-8 px-4 sm:px-6 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-ap-gray text-sm">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => navigate('/pricing')} className="text-ap-gray3 hover:text-ap-gray text-xs transition-colors">Pricing</button>
            <Link to="/login" className="text-ap-gray3 hover:text-ap-gray text-xs transition-colors">Log in</Link>
          </div>
