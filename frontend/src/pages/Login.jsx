    ...
    <div className="min-h-dvh flex items-center justify-center bg-slate-900 px-4">
      <div className="w-full max-w-sm animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">HK Camera</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-slate-400 hover:text-slate-200 rounded-lg transition-colors">
        ...
        <p className="text-center text-slate-400 text-sm mt-5">
          ...
          <Link to="/register" className="text-hk-400 hover:text-hk-300 font-medium">Create one</Link>
        </p>
      </div>
    </div>
  );
