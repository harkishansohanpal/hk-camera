...
import { Activity, FileText, MessageSquare, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-900 flex">
      ...
      <aside className="w-56 bg-slate-950 border-r border-slate-800 flex flex-col flex-shrink-0">
        <div className="p-4 border-b border-slate-800">
          <NavLink to="/admin" className="text-sm font-bold text-white tracking-tight">
            ⚙ Admin
          </NavLink>
          <p className="text-[10px] text-slate-500 mt-0.5">Production Support</p>
        </div>
